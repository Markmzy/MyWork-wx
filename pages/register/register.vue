<template>
	<view>
		...
		<view class="register-container">
			<input type="text" placeholder="输入你的注册邀请码" class="register-code" maxlength="8" v-model="registerCode" />
			<view class="register-desc">管理员创建员工账号之后，你可以从你的企业邮箱中获得注册邀请码</view>
